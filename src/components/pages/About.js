            ...
            <div className="wrap renderpage">
                <div id="wrap_profile">
                    ...
                    <p>
                        ...
                        (python, java, c++, c, and etc). I transitioned from a role as a technology analyst to 
                        ...
                        and I am committed to continuously improving my abilities in this field while staying up-to-date with the latest technologies.
                        <br/><br/>
                    </p>
                </div>
            </div>
